...
//   phoneNumber?: string
// }
export const identificationProcess = async (req, res) => {
    try {
        ...
        if (existingContacts.length === 0) {
            ...
            if (email && phoneNumber) {
                const primaryCandidates = existingContacts.filter((contact) => contact.linkedPrecedence === "primary");
...
//# sourceMappingURL=identification_process.js.map